...
insert into users(id, user_type, first_name, last_name, affiliation, email) values (1000, 'RESEARCHER', 'Nikos', 'Diamantidis', 'AUEB', 'ndia@aueb.gr');
insert into users(id, user_type, first_name, last_name, affiliation, email) values (1001, 'RESEARCHER', 'Pooja', 'Rani', 'University of Bern', 'pooja.rani@unibe.ch');
insert into users(id, user_type, first_name, last_name, affiliation, email) values (1002, 'RESEARCHER', 'Enrico', 'Fregnan', 'University of Zurich', 'fregnan@ifi.uzh.ch');
insert into users(id, user_type, first_name, last_name, affiliation, email) values (1003, 'EDITOR', 'Paris', 'Avgeriou', 'University of Groningen', 'avgeriou@gmail.com');
